...
public class UpdateLessonStudentModelValidator : AbstractValidator<UpdateLessonStudentModel>
{
    private readonly ILessonStudentRepository _lessonStudentRepository;
    private readonly UserManager<ApplicationUser> _userManager;

    public UpdateLessonStudentModelValidator(ILessonStudentRepository lessonStudentRepository, UserManager<ApplicationUser> userManager)
    {
